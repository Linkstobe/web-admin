...
import { ISponsor, ISponsorConfig } from "@/interfaces/IAffiliateSubCommissionConfig";
...
interface EditSponsorCommissionModalProps {
  children: ReactNode;
  sponsor: ISponsor;
  existingConfig: ISponsorConfig | null;
  onSuccess: () => void;
}
...
export default function EditSponsorCommissionModal({
  children,
  sponsor,
  existingConfig,
  onSuccess,
}: EditSponsorCommissionModalProps) {
  ...
  const onSubmit = async (values: CommissionFormValues) => {
    try {
      ...
      console.error("EditSponsorCommissionModal:", error);
  ...
  return (
    <Modal.Root>
      ...
      <Modal.Container>
        ...
        <Modal.Header>
          <Modal.Title title={`Configurar subcomissão - ${sponsor.name}`} />
        </Modal.Header>
        <Modal.Content>
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-blue-800">
                ...
                <p className="mb-2">
                  Esses percentuais serão aplicados sobre a comissão de{" "}
                  <strong>todos os afiliados</strong> indicados por este sponsor
                  quando fizerem uma venda.
                </p>
