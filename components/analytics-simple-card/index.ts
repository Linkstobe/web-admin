...
import AnalyticsSimpleCardTopSection from "./analytics-simple-card-top-section";
import AnalyticsSimpleCardValue from "./analytics-simple-card-value";

export const AnalyticsSimpleCard = {
  Root: AnalyticsSimpleCardRoot,
  TopSection: AnalyticsSimpleCardTopSection,
  BodySection: AnalyticsSimpleBodySection,
